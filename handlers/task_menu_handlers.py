...
from config import VIEW_MENU, VIEW_TASKS_STATE, ADD_TASK_STATE, REMOVE_TASK_STATE
# Initiating logger
    ...
    return ConversationHandler(
        ...
        states = {
            VIEW_TASKS_STATE : [
                ...
                CallbackQueryHandler(pattern='^tasks_return_btn$', callback=return_to_main_menu)
            ],
            ADD_TASK_STATE : [
        ...
        fallbacks = [
            CallbackQueryHandler(pattern="^return_button$", callback=view_task_menu),
